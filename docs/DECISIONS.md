...
4. **Reminders tab is new scope** beyond SPEC.md. Ships as a placeholder in Phase 1; feature design deferred until the capture loop works. Note: timed notifications require a dev build (not Expo Go).
